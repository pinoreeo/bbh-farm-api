...
class PostnatalCareRecordController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if (! $birthEvent) {
            return response()->json([
                'message' => 'Data kelahiran untuk cempe yang dipilih tidak ditemukan.',
            ], 422);
        }
        ...
        if ($birthEvent->birth_date && $data['care_date'] < $birthEvent->birth_date->toDateString()) {
            return response()->json([
                'message' => 'Tanggal perawatan tidak boleh lebih awal dari tanggal kelahiran cempe.',
            ], 422);
        }
        ...
        if ($exists) {
            return response()->json([
                'message' => 'Data perawatan pascalahir untuk cempe tersebut sudah pernah dicatat.',
            ], 422);
        }
        ...
        return response()->json([
            'message' => 'Data perawatan pascalahir berhasil disimpan.',
    ...
    public function update(Request $request, PostnatalCareRecord $postnatalCareRecord): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'Data perawatan pascalahir berhasil diperbarui.',
    ...
    private function resolveOffspringBirth(array $data): OffspringBirth|JsonResponse
    {
        ...
        if (! $offspringBirth) {
            return response()->json([
                'message' => 'Tag cempe yang dipilih belum tercatat pada data cempe lahir.',
            ], 422);
        }
