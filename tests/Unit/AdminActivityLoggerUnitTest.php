...
class AdminActivityLoggerUnitTest extends ApiTestCase
{
    ...
    public function test_logger_writes_admin_activity_with_safe_metadata_and_response_subject(): void
    {
        ...
        $this->assertStringContainsString('menambahkan data kambing', strtolower($log->description));
    }
    ...
    public function test_logger_records_failed_action_description_for_error_response(): void
    {
        ...
        $this->assertStringContainsString('mencabut akte dan sertifikat', strtolower($log->description));
        $this->assertStringContainsString('belum berhasil', strtolower($log->description));
    }
}
